...
Friendly, energetic, **operator-grade**. Coach's coaches juggle a lot — payments, sessions, meal plans, exercise libraries with 2,761 entries — so the UI stays calm and dense, then uses one loud accent (lime) to point at the next action. The mascot (a smiling kettlebell named **Bell**) is the emotional anchor; he shows up in empty states and onboarding, never in dense data views.
...
- `ui_kits/dashboard/` — full Coach dashboard composed from the kit, ready to clone for new screens
